//Adapted from Nathan Seidle's example of how to use the PDM on Artemis boards.
...
//Define the min and max frequencies for whistling
#define MIN_WHISTLE_FREQ 1500
#define MAX_WHISTLE_FREQ 4000
...
void printLoudest(void)
{
  ...
  detectWhistle(ui32LoudestFrequency);

}

void detectWhistle(uint32_t freq) {
  if (freq > MIN_WHISTLE_FREQ && freq < MAX_WHISTLE_FREQ) { // Whistle detected
